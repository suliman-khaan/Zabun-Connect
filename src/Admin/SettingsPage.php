...
class SettingsPage
{
    ...
    public function register_settings(): void
    {
        ...
        add_settings_field(
            'zabun_connect_sync_source',
            __('Sync Source / Scope', 'zabun-connect'),
            [$this, 'render_sync_source_field'],
            'zabun-connect',
            'zabun_sync_section'
        );
        ...
        add_settings_field(
            'zabun_connect_language',
            __('Language / Language Data', 'zabun-connect'),
    ...
    /**
     * Sanitize language callback.
     */
    public function sanitize_language($value): string
    {
        $allowed = ['nl', 'fr', 'en'];
        return in_array($value, $allowed, true) ? $value : 'nl';
    }
    ...
    public function render_api_key_field(): void
    {
        ...
        ?>
        <input type="text" id="zabun_connect_api_key" name="zabun_connect_api_key" value="<?php echo esc_attr($display); ?>"
            placeholder="<?php esc_attr_e('Enter Zabun API Key', 'zabun-connect'); ?>" class="regular-text"
            autocomplete="off" />
    ...
    public function render_client_id_field(): void
    {
        ...
        ?>
        <input type="text" id="zabun_connect_client_id" name="zabun_connect_client_id" value="<?php echo esc_attr($val); ?>"
            placeholder="<?php esc_attr_e('e.g. 10001 or UUID', 'zabun-connect'); ?>" class="regular-text" autocomplete="off" />
    ...
    public function render_server_id_field(): void
    {
        ...
        ?>
        <input type="text" id="zabun_connect_server_id" name="zabun_connect_server_id" value="<?php echo esc_attr($val); ?>"
            placeholder="<?php esc_attr_e('e.g. 1 or UUID', 'zabun-connect'); ?>" class="regular-text" autocomplete="off" />
    ...
    public function render_x_client_id_field(): void
    {
        ...
        ?>
        <input type="text" id="zabun_connect_x_client_id" name="zabun_connect_x_client_id" value="<?php echo esc_attr($val); ?>"
            placeholder="<?php esc_attr_e('e.g. 235 or Company ID', 'zabun-connect'); ?>" class="regular-text"
            autocomplete="off" />
    ...
    public function render_media_id_field(): void
    {
        ...
        ?>
        <input type="number" id="zabun_connect_media_id" name="zabun_connect_media_id" value="<?php echo esc_attr($val); ?>"
            class="small-text" />
        <p class="description">
            <?php esc_html_e('Media ID for your website (Default: 14 for "Website via API").', 'zabun-connect'); ?>
        </p>
        <?php
    }
    ...
    public function render_base_url_field(): void
    {
        ...
        ?>
        <input type="url" id="zabun_connect_base_url" name="zabun_connect_base_url" value="<?php echo esc_attr($url); ?>"
            class="regular-text" />
    ...
    /**
     * Sanitize sync source callback.
     */
    public function sanitize_sync_source($value): string
    {
        $allowed = ['all', 'media_sync'];
    ...
    public function render_sync_interval_field(): void
    {
        ...
        <select id="zabun_connect_sync_interval" name="zabun_connect_sync_interval">
            <option value="hourly" <?php selected($interval, 'hourly'); ?>>
                <?php esc_html_e('Hourly (Recommended)', 'zabun-connect'); ?>
            </option>
            <option value="twicedaily" <?php selected($interval, 'twicedaily'); ?>>
                <?php esc_html_e('Twice Daily (Every 12 hours)', 'zabun-connect'); ?>
            </option>
            <option value="daily" <?php selected($interval, 'daily'); ?>>
                <?php esc_html_e('Daily (Every 24 hours)', 'zabun-connect'); ?>
            </option>
        </select>
        <p class="description">
            <?php esc_html_e('How often listings are fetched and updated in local cache.', 'zabun-connect'); ?>
        </p>
        <?php
    }

    public function render_sync_source_field(): void
    {
        $source = (string) get_option('zabun_connect_sync_source', 'all');
        ?>
        <select id="zabun_connect_sync_source" name="zabun_connect_sync_source">
            <option value="all" <?php selected($source, 'all'); ?>><?php esc_html_e('All CRM Listings', 'zabun-connect'); ?>
            </option>
            <option value="media_sync" <?php selected($source, 'media_sync'); ?>>
                <?php esc_html_e('Published to Media Channel', 'zabun-connect'); ?>
            </option>
        </select>
        <p class="description">
            <?php esc_html_e('Select whether to sync all properties in your Zabun CRM database or only properties assigned to the Media Channel.', 'zabun-connect'); ?>
        </p>
        <?php
    }
    ...
    public function render_currency_symbol_field(): void
    {
        ...
        <input type="text" id="zabun_connect_currency_symbol" name="zabun_connect_currency_symbol"
            value="<?php echo esc_attr($val); ?>" placeholder="€" class="small-text" />
        <p class="description">
            <?php esc_html_e('Currency symbol displayed with listing prices across your site (e.g. €, $, £, CHF, AED). Default: €', 'zabun-connect'); ?>
        </p>
        <?php
    }
    ...
    {
        $lang = (string) get_option('zabun_connect_language', 'nl');
        ?>
        <select id="zabun_connect_language" name="zabun_connect_language">
            <option value="nl" <?php selected($lang, 'nl'); ?>><?php esc_html_e('Nederlands (Dutch)', 'zabun-connect'); ?>
            </option>
            <option value="fr" <?php selected($lang, 'fr'); ?>><?php esc_html_e('Français (French)', 'zabun-connect'); ?>
            </option>
            <option value="en" <?php selected($lang, 'en'); ?>><?php esc_html_e('English (English)', 'zabun-connect'); ?>
            </option>
        </select>
        <p class="description">
            <?php esc_html_e('Select the language for listings data (title, description, property types, address details) and UI elements (buttons, filters, labels). Zabun API provides multilingual responses in NL, FR, and EN.', 'zabun-connect'); ?>
        </p>
        <?php
    }
    ...
    public function render_page(): void
    {
        ...
        <div class="wrap zabun-settings-wrap">
            <h1 class="wp-heading-inline"
                style="position:absolute;margin:-1px;padding:0;height:1px;width:1px;overflow:hidden;clip:rect(0,0,0,0);border:0;">
                <?php esc_html_e('Zabun Connect', 'zabun-connect'); ?>
            </h1>
            ...
            <div class="zabun-grid-layout">
                <div class="zabun-main-column">
                    ...
                    <div class="zabun-card">
                        <h2 class="zabun-card-title">
                            <?php esc_html_e('Shortcodes & Elementor Widgets Guide', 'zabun-connect'); ?>
                        </h2>
                        <p><?php esc_html_e('You can display property listings anywhere on your site using standard WordPress shortcodes or Elementor drag-and-drop widgets.', 'zabun-connect'); ?>
                        </p>
                        ...
                        <div class="zabun-guide-block">
                            ...
                            <p><?php esc_html_e('Displays responsive property listing cards with pagination, status badges, and facts.', 'zabun-connect'); ?>
                            </p>
                            <code
                                class="zabun-guide-code">[zabun_grid columns="3" limit="9" status="for_sale" pagination="yes"]</code>
                            <ul class="zabun-param-list">
                                <li><code>columns</code> : <code>1</code>, <code>2</code>, <code>3</code>, or <code>4</code>
                                    (Default: <code>3</code>)</li>
                                <li><code>limit</code> : Number of listings per page (Default: <code>9</code>)</li>
                                <li><code>status</code> : <code>for_sale</code>, <code>for_rent</code>, <code>sold</code>, or
                                    <code>rented</code> (Default: all)
                                </li>
                                <li><code>city</code> : Filter by specific city (e.g. <code>Brussels</code>,
                                    <code>Antwerp</code>)
                                </li>
                                <li><code>type</code> : Filter by property type (e.g. <code>Villa</code>,
                                    <code>Apartment</code>, <code>House</code>)
                                </li>
                                <li><code>orderby</code> : <code>date</code>, <code>price</code>, <code>title</code>, or
                                    <code>living_area</code>
                                </li>
                        ...
                        <div class="zabun-guide-block">
                            ...
                            <p><?php esc_html_e('Renders full luxury property details with photo gallery, specs table, features list, and agent contact sidebar.', 'zabun-connect'); ?>
                            </p>
                            <code class="zabun-guide-code">[zabun_detail]</code>
                            <ul class="zabun-param-list">
                                <li><code>[zabun_detail]</code> : Automatically pulls the property ID from the URL parameter
                                    (<code>?property_id=XYZ</code>).</li>
                                <li><code>[zabun_detail id="ZB-1001"]</code> : Manually embed a specific property by its Zabun
                                    reference or ID.</li>
                            </ul>
                        </div>
                        ...
                        <div class="zabun-guide-block">
                            ...
                            <p><?php esc_html_e('Displays the interactive Hero search bar with status tabs, city/type filters, and expandable drawer with price/bedroom ranges.', 'zabun-connect'); ?>
                            </p>
                            <code class="zabun-guide-code">[zabun_search action_url="/properties/"]</code>
                            <ul class="zabun-param-list">
                                <li><code>action_url</code> : Target page URL where search results should be submitted (Leave
                                    empty for current page).</li>
                            </ul>
                        </div>
                        ...
                        <div class="zabun-guide-block">
                            ...
                            <p><?php esc_html_e('Compact property highlights grid suitable for homepages and landing pages.', 'zabun-connect'); ?>
                            </p>
                        ...
                        <div class="zabun-guide-block">
                            ...
                            <p><?php esc_html_e('If you use Elementor, simply search for "Zabun" in the Elementor widgets panel. You can visually configure custom SVG icons, colors, typographies, and badge styles directly in the editor!', 'zabun-connect'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="zabun-side-column">
                    ...
                    <div class="zabun-card">
                        ...
                        <ul class="zabun-status-list">
                            <li class="zabun-status-item">
                                <span
                                    class="zabun-status-label"><?php esc_html_e('Cached Listings:', 'zabun-connect'); ?></span>
                                <span class="zabun-status-val"
                                    id="zabun-cached-count"><?php echo esc_html($cached_count); ?></span>
                            </li>
                            <li class="zabun-status-item">
                            ...
                            <li class="zabun-status-item">
                                <span
                                    class="zabun-status-label"><?php esc_html_e('Database Version:', 'zabun-connect'); ?></span>
                    ...
                    <div class="zabun-card">
                        ...
                        <p><?php esc_html_e('Download and refresh all listings now into the local database.', 'zabun-connect'); ?>
                        </p>
